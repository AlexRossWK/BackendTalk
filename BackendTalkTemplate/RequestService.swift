...
public class RequestService: RequestServiceProtocol {
    ...
    public func makeJsonRequest<T>(request: RequestProtocol,
                                     responseType: T.Type,
                                     ...
                                     codingStrategy: JSONDecoder.KeyDecodingStrategy = .useDefaultKeys) where T: Decodable {
    ...
    public func makeMultipartDataRequest<T>(request: RequestProtocol,
                                              responseType: T.Type,
                                              onComplete: @escaping (_ response: T, _ statusCode: Int?) -> Void,
                                              onError: @escaping (_ error: Error?, _ statusCode: Int?, _ response: T?) -> Void,
